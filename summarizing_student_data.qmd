...
students |>
  ...
  labs(title = "Relationship between First Period Math Grade and Final Grade",
       ...
       color = "Extra Paid \nClasses")
```
*Takeaway: first period and final period math scores appear fairly correlated; these is no obvious clustering for students with extra paid math classes*
...
students |>
  ...
  facet_wrap(~ studytime, labeller = study_time)
```
*Takeaway: final math and Portuguese scores appear correlated with medium strength across all facet levels; those with over 10 study hours appear to be more tightly packed toward the upper right*
...
students |>
  ...
  ylab("Final Math Grade") +
  labs(title = "Relationship between First Period Math Grade and Final Grade",
       subtitle = "Considering Effects of Paid Extra Classes and Studytime") +
